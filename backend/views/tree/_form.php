...
<div class="tree-information-form">
    ...
    <?= $form->field($model, 'tree_image[]')->widget(FileInput::classname(), [
        ...
        'pluginOptions' => [
            'previewFileType' => 'any',
            'uploadUrl' => Url::to(['/tree/upload']),
            'Onfiledeleted'=>function () {
                alert(123);
            },
        ],
        'pluginEvents'=>[
            'filedelete' => 'function() { console.log("filedelete"); }',
        ...
        <div id="myId" class="myId">
            <div class="dropzone-previews" style="display:none;">
                <div class="dz-preview dz-file-preview">
                  <div class="dz-details" title="点击删除">
                    <img src="" data-dz-thumbnail data-dz-remove/>
                  </div>
                  <div class="dz-error-message"><span data-dz-errormessage></span></div>
                </div>
            </div>
        </div>
        <div class="myId" onclick="toggle(false);" style="display:none;">
